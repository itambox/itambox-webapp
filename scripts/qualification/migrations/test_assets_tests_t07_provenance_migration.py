...
class T07ProvenanceMigrationTests(IsolatedMigrationTestCase):
    ...
    def test_forward_preserves_ids_values_composition_tokens_and_archive(self):
        ...
        empty_library = AssetTypeLibrary.objects.create(
            pk=701, namespace="empty-stage", release="", source_checksum=None, managed_paths={}, last_reconciled_at=None
        )
        ...
        self.assertEqual(
            migrated_local.custom_field_data, {"memory_capacity": "16.000", "enabled": False, "operator_note": "retain"}
        )
        ...
        self.assertEqual(
            list(migrated_fieldset.field_memberships.values_list("custom_field_id", "position")), [(field.pk, 4)]
        )
