...
CloneObject = ObjectAction("clone", _("Clone"), icon="mdi-content-copy", permissions_required=("add",))
CheckoutObject = ObjectAction(
    "checkout", _("Checkout"), icon="mdi-arrow-right-bold-box", permissions_required=("change",)
)
CheckinObject = ObjectAction("checkin", _("Checkin"), icon="mdi-arrow-left-bold-box", permissions_required=("change",))
AuditObject = ObjectAction("audit", _("Audit"), icon="mdi-clipboard-check", permissions_required=("change",))
PrintLabelObject = ObjectAction("label", _("Print Label"), icon="mdi-printer", permissions_required=("view",))
