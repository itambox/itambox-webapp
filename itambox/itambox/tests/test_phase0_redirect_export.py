...
class JournalEntryRedirectTests(TestCase):
    ...
    def setUp(self):
        ...
        self.manufacturer = Manufacturer.objects.create(name="Redirect Mfr", slug="redirect-mfr")
        self.url = reverse(
            "journal_entry_add",
            kwargs={
                "app_label": "assets",
    ...
    def test_evil_return_url_is_not_honoured(self):
        ...
        response = self.client.post(self.url, {"comment": "hello", "return_url": evil})
    ...
    def test_same_host_return_url_is_preserved(self):
        ...
        response = self.client.post(self.url, {"comment": "hi", "return_url": safe})
        self.assertEqual(response.status_code, 302)
