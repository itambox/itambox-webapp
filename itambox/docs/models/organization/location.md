...
Locations are essential for stock management inside ITAMbox. Bulk items (accessories and consumables) and components are checked into specific locations where they reside in physical inventory.
