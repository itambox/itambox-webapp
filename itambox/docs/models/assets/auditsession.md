...
A clear name for the audit campaign (e.g. `Q2 IT Stockroom audit`).

**Required:** Yes.

### Location

Optional Site Location room to focus the audit on. If blank, the audit campaign is global.

### Status

Session state: `Planned`, `Active`, `Completed`.

**Required:** Yes.

### Started At

The timestamp when the audit was opened.

**Required:** Yes.

### Completed At

The timestamp when the audit session was finalized.

### Created By

The administrative user who launched the session.
