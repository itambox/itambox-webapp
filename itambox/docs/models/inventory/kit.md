...
Unique name identifying the kit bundle template. Globally unique across active (non-deleted) kits.

**Required:** Yes.

### Description

Optional notes describing the target audience, use case, or hardware configurations.

### Tenant

Owning tenant. Null denotes a shared/global kit template visible to all tenants.
