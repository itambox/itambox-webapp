...
PYTHONPATH=itambox uv run --locked --group dev python -m pytest -q -p no:cacheprovider \
  ...
  itambox/assets/tests/test_issue390_reservation_quick_add.py \
  ...
  itambox/itambox/tests/test_generic_view_foundations.py \
  itambox/itambox/tests/test_rest_api_options.py \
  itambox/tests/test_issue389_accessibility.py \
  ...
  itambox/core/tests/test_prod_settings.py \
  ...
  itambox/users/tests/test_default_workspace.py \
  ...
  itambox/users/tests/test_usergroup_escalation.py \
