...
urlpatterns = [
    ...
    path(
        "consumables/<int:pk>/add-stock/", views.ConsumableStockCreateModalView.as_view(), name="consumable_add_stock"
    ),
    ...
    path(
        "consumable-stocks/<int:pk>/delete/", views.ConsumableStockDeleteView.as_view(), name="consumablestock_delete"
    ),
    path(
        "consumable-stocks/<int:pk>/adjust/", views.ConsumableStockAdjustView.as_view(), name="consumablestock_adjust"
    ),
    # Kits
    ...
    path(
        "component-allocations/<int:pk>/edit/",
        views.ComponentAllocationEditView.as_view(),
        name="componentallocation_update",
    ),
    path(
        "component-allocations/<int:pk>/delete/",
        views.ComponentAllocationDeleteView.as_view(),
