...
class StockCRUDViewTests(TestCase):
    def setUp(self):
        ...
        self.location = Location.objects.create(
            name="Location Y", slug="location-y", site=self.site, tenant=self.tenant
        )
...
class StockAlertsTests(TestCase):
    ...
    def test_low_stock_threshold_alert(self):
        ...
        channel = NotificationChannel.objects.create(name="In-App Channel", channel_type="in_app", enabled=True)
