...
from assets.models import AssetType, Category, Manufacturer, StatusLabel
from inventory.models import Accessory, Consumable, ConsumableAssignment, ConsumableStock, Kit, KitItem
