...
urlpatterns = [
    ...
    path(
        "contact-assignments/<int:pk>/delete/",
    ...
    path(
        "resource-grants/add/<int:content_type_id>/<int:resource_id>/",
        views.TenantResourceGrantCreateView.as_view(),
        name="tenantresourcegrant_add",
    ),
    path(
        "resource-grants/<int:pk>/delete/",
