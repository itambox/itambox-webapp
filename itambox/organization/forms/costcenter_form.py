...
class CostCenterForm(CustomFieldModelFormMixin, forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(Div("tenant", css_class="col-md-6"), Div("parent", css_class="col-md-6"), css_class="row"),
            "description",
            "is_active",
        )
        ...
        if parent and self.instance and self.instance.pk:
            ...
            while node is not None:
                if node.pk == self.instance.pk:
                    raise forms.ValidationError(_("Setting this parent would create a cycle in the hierarchy."))
