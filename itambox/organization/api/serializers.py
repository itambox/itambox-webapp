...
class LocationSerializer(BaseModelSerializer):
    ...
    site_id = serializers.PrimaryKeyRelatedField(queryset=Site.objects, source="site", write_only=True)
...
class TenantSerializer(BaseModelSerializer):
    ...
    class Meta:
        model = Tenant
        fields = ["id", "url", "name", "slug", "group", "group_id", "description", "created_at", "updated_at"]
        brief_fields = ["id", "url", "name", "slug"]
...
class AssetHolderSerializer(BaseModelSerializer):
    ...
    class Meta:
        model = AssetHolder
        fields = ["id", "url", "upn", "email", "tenant", "tenant_id", "assignment_count", "created_at", "updated_at"]
