...
from core.mfa import PASSWORD_BACKEND, request_needs_mfa, user_requires_mfa
...
class MFAPolicyHelperTests(TestCase):
    ...
    def setUp(self):
        ...
        self.manager_user = User.objects.create_user(
            username="manager-mfa",
            email="manager-mfa@example.com",
            password="pw-mfa",
        )
...
class MFAPolicyNoStaleCacheTests(TestCase):
    ...
    def setUp(self):
        ...
        self.tenant = Tenant.objects.create(
            name="No Cache Tenant MFA",
            slug="no-cache-tenant-mfa",
        )
        self.user = User.objects.create_user(
            username="nocache-mfa",
            email="nocache-mfa@example.com",
            password="pw-mfa",
        )
...
class MFAEnforcementMiddlewareTests(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_user = User.objects.create_user(
            username="enforce-admin-mfa",
            email="enforce-admin-mfa@example.com",
            password="pw-mfa",
        )
        ...
        self.manager_user = User.objects.create_user(
            username="enforce-manager-mfa",
            email="enforce-manager-mfa@example.com",
            password="pw-mfa",
        )
        manager_role = Role.objects.create(
            tenant=self.tenant,
        ...
        self.member_user = User.objects.create_user(
            ...
            email="enforce-member-mfa@example.com",
            password="pw-mfa",
        )
...
class MFAGateViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_user = User.objects.create_user(
            username="gate-admin-mfa",
            email="gate-admin-mfa@example.com",
            password="pw-mfa",
        )
        admin_role = Role.objects.create(tenant=self.tenant, name="Admin", permissions=[])
        grant(self.admin_user, self.tenant, admin_role)
