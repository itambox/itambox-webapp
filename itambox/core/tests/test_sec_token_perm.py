...
class TokenPermissionsBypassRemovedTests(TestCase):
    def setUp(self):
        ...
        self.member = User.objects.create_user(username="member-f7", password="password123")
        ...
        self.orphan = User.objects.create_user(username="orphan-f7", password="password123")
    ...
    def test_unscoped_user_denied_without_test_bypass(self):
        ...
        self.assertFalse(Membership.objects.filter(user=self.orphan).exists())
