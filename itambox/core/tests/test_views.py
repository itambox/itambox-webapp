...
class CoreViewsTestCase(TestCase):
    ...
    def test_objectchange_resolved_data(self):
        ...
        asset_type = AssetType.objects.create(
            manufacturer=mfr, model="Surface Book unique-test-change", slug="surface-book-unique-test-change"
        )

        asset = Asset.objects.create(name="Alice Surface", asset_tag="SRF-001", asset_type=asset_type, asset_role=role)
    ...
    def test_objectchange_hides_system_events_by_default(self):
        ...
        shown_qs = ObjectChangeFilterSet({"show_system_events": "on"}, queryset=ObjectChange.objects.all()).qs
    ...
    def test_softdelete_management_views(self):
        ...
        asset = Asset.objects.create(name="Alice ThinkPad", asset_tag="TP-001", asset_type=asset_type, asset_role=role)
        ...
        asset2 = Asset.objects.create(name="Bob ThinkPad", asset_tag="TP-002", asset_type=asset_type, asset_role=role)
        asset3 = Asset.objects.create(
            name="Charlie ThinkPad", asset_tag="TP-003", asset_type=asset_type, asset_role=role
        )
    ...
    def test_recycle_bin_permissions(self):
        ...
        asset = Asset.objects.create(
            name="Bob ThinkPad", asset_tag="TP-999", asset_type=asset_type, asset_role=role, tenant=tenant
        )
        asset.delete()
