...
class StatusLabelForm(ColorFieldFormMixin, forms.ModelForm):
    ...
    type = forms.ChoiceField(choices=StatusLabel.TYPE_CHOICES, widget=forms.Select(attrs={"class": "form-select"}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                ...
                Column(
                    HTML(
                        f'<a href="{cancel_url}" class="btn btn-outline-secondary ms-2" data-no-dirty-track="true">Cancel</a>'
                    ),
