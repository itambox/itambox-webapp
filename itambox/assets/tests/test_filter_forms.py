...
from organization.models import Location, Tenant, Site
from assets.models import Asset, AssetType, Manufacturer, Supplier, StatusLabel
...
class AssetFilterFormTest(TestCase):
    def setUp(self):
        ...
        self.asset_type = AssetType.objects.create(manufacturer=self.manufacturer, model="Latitude 5420")
    ...
    def test_empty_form_ajax_attributes_and_empty_querysets(self):
        ...
        ajax_fields = ['location', 'asset_type', 'manufacturer', 'supplier', 'tenant', 'tags']
