...
from core.api.utils import get_annotations_for_serializer, get_prefetches_for_serializer
from core.api.mixins import BulkUpdateModelMixin, BulkDestroyModelMixin, ObjectValidationMixin, ETagMixin
