...
class SubscriptionAPITests(APITestCase):
    def setUp(self):
        ...
        # Create Tenant & AssetHolder profile for staff user to satisfy StrictTenantPermission
        ...
        # Grant specific subscriptions permission codenames to staff user for TokenPermissions validation
