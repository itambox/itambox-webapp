...
## Support Contacts
Manufacturers support a polymorphic generic relation to `Contact Assignment`. AssetBox can automatically resolve the active support contact, first searching for contacts with roles matching `support` or `technical-support`, falling back to `primary` contacts, and eventually any registered vendor assignments.
