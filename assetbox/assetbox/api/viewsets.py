...
from assetbox.api.utils import get_annotations_for_serializer, get_prefetches_for_serializer
from assetbox.api.mixins import BulkUpdateModelMixin, BulkDestroyModelMixin, ObjectValidationMixin, ETagMixin
...
class AssetBoxReadOnlyModelViewSet(
    ETagMixin,
